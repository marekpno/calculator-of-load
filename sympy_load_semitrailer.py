...
df.columns = ['location from king pin [mm]', f'Ql max  {Rc_max} t for kingpin', f'Ql max  {Rd_max} t for axes']

# check the minimum Ql
columns_range = [ f'Ql max  {Rc_max} t for kingpin', f'Ql max  {Rd_max} t for axes']
...
df.columns = ['location from king pin [mm]', f'Ql max  {Rc_max} t for kingpin', f'Ql max  {Rd_max} t for axes', 'Qlmax']
